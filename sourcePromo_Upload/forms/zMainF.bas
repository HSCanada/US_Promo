        ...
        Begin Section
            ...
            Begin
                ...
                Begin Label
                    ...
                    ForeColor =8421376
                    Name ="Text65"
                    Caption ="Dental  Defaulted  Promotions  UpLoad  db"
                    FontName ="Small Fonts"
                End
                Begin TextBox
                    Visible = NotDefault
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT DISTINCT zVendor.ID, zVendor.Company FROM zVendor INNER JOIN zPromo ON zV"
                        "endor.ID=zPromo.ID WHERE (((zPromo.EffQtr)=ZEffQtr()) AND ((zPromo.EffYr)=ZEffYr"
                        "())) OR (((zPromo.EffYr)=ZEffYr()) AND ((zPromo.EffMnth)=ZEffMn())) ORDER BY zVe"
                        "ndor.Company; "
                    ColumnWidths ="0;2385"
                    AfterUpdate ="[Event Procedure]"
                    FontName ="Small Fonts"
                ...
                Begin Label
                    ...
                    FontWeight =700
                    Name ="Label46"
                    Caption ="The above are all sorted from most recent to the oldest Mfg redemptions. Use for"
                        " managing Sale Flyer special redemption programs"
                    FontName ="Small Fonts"
                End
                Begin ComboBox
                    Visible = NotDefault
                ...
                Begin Label
                    ...
                    ForeColor =13434828
                    Name ="Label89"
                    Caption ="Now allows vendor edit w/ a view only of Mktg DB Contacts"
                    FontName ="Small Fonts"
                End
                Begin CommandButton
                    Visible = NotDefault
                ...
                Begin Label
                    ...
                    ForeColor =13434828
                    Name ="Label104"
                    Caption ="The Import process now eliminates any duplicate family set code entries "
                    FontName ="Small Fonts"
                End
                Begin Label
                    Visible = NotDefault
                ...
                Begin ComboBox
                    ...
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT DISTINCT zVendor.ID, zVendor.Company FROM zVendor INNER JOIN zPromo ON zV"
                        "endor.ID=zPromo.ID WHERE (((zPromo.EffMnth)=ZEffMn()) AND ((zPromo.EffYr)=ZEffYr"
                        "())) ORDER BY zVendor.Company; "
                    ColumnWidths ="0;2384"
                    AfterUpdate ="[Event Procedure]"
                    FontName ="Small Fonts"
                ...
                Begin Label
                    ...
                    BackColor =13434828
                    Name ="VerProd"
                    Caption ="Defaulted_Promo_UpLoad db"
                    FontName ="Rockwell"
                End
                Begin Label
                    Visible = NotDefault
                ...
                Begin TextBox
                    ...
                    ForeColor =13434828
                    Name ="DbNm"
                    ControlSource ="=\"Full db Name:  \" & Application.CurrentProject.Path & \"\\\" & Application.Cu"
                        "rrentProject.Name"
                    FontName ="Small Fonts"
                ...
                Begin Label
                    ...
                    FontWeight =700
                    Name ="Label178"
                    Caption ="See 10.1-4 VIP Admin and 7.D. and 9. and 8.2-8.4., for more data checks"
                    FontName ="Small Fonts"
                End
                Begin CommandButton
                    Visible = NotDefault
                ...
                Begin CommandButton
                    ...
                    ForeColor =255
                    Name ="NullBuyOrIC"
                    Caption ="1. Look for zPromos w/o Buys or Items"
                    OnClick ="[Event Procedure]"
                    FontName ="Small Fonts"
                ...
                Begin CommandButton
                    ...
                    FontWeight =700
                    TabIndex =106
                    Name ="VuDestinatnFiles"
                    Caption ="3. Vu  Xport Files"
                    OnClick ="[Event Procedure]"
                    FontName ="Small Fonts"
                ...
                Begin Label
                    ...
                    FontSize =7
                    Name ="Label236"
                    Caption ="Use <Esc> key to cancel upload"
                    FontName ="Small Fonts"
                End
                Begin Rectangle
                    SpecialEffect =1
                ...
                Begin Label
                    ...
                    FontWeight =700
                    Name ="Label238"
                    Caption ="1. UpLoad Defaulted Promos to AS400"
                    FontName ="Times New Roman"
                End
                Begin TextBox
                    OverlapFlags =85
                ...
                Begin ComboBox
                    ...
                    ControlSource ="FP"
                    RowSourceType ="Value List"
                    RowSource ="\"P\";\"Proof\";\"F\";\"Final"
                    ColumnWidths ="390;864"
                    DefaultValue ="\"F\""
                    FontName ="Small Fonts"
                ...
                Begin Label
                    ...
                    Height =240
                    Name ="Label248"
                    Caption ="\\\\usnym3fs03\\Data\\Dental\\dentmkt\\Promo\\PromoUpLdRpts"
                End
                Begin CommandButton
                    OverlapFlags =247
                    Left =7995
                    ...
                    TabIndex =116
                    Name ="VuFullTxt"
                    Caption ="5. Vu Full Text of Exports"
                    OnClick ="[Event Procedure]"
                    FontName ="Small Fonts"
                ...
                Begin CommandButton
                    ...
                    TabIndex =118
                    Name ="BadTxt"
                    Caption ="1. Check for Any Bad BUY/GET Text?"
                    OnClick ="[Event Procedure]"
                    FontName ="Small Fonts"
                ...
                Begin CommandButton
                    ...
                    TabIndex =120
                    Name ="ShoAll"
                    Caption ="2. Show All Upload Records"
                    OnClick ="[Event Procedure]"
                    FontName ="Small Fonts"
                ...
                Begin CommandButton
                    ...
                    TabIndex =121
                    Name ="SWOvsDft"
                    Caption ="3. Show SWO/Dft Conflicts"
                    OnClick ="[Event Procedure]"
                    FontName ="Small Fonts"
...
On Error GoTo Err_BadTxt_Click
    ...
    If IsNull(Me![TestEffDt]) Then
       ...
       ZNow() = Me![TestEffDt]
    Else
       If IsDate(Me![TestEffDt]) Then
           Z_Now = Me![TestEffDt]
       Else
           MsgBox "The date in 'Proof or Test Date' (above) is not " & _
           "a valid date, please use the mm/dd/yyy format, and try again."
           Exit Sub
       End If
    End If
...
'    DoCmd.OpenQuery "zWCSItmSetUQ"
    ...
    DoCmd.OutputTo acOutputReport, stDocName, acFormatSNP, stPath
...
config_log "Form_zMainF - TestEffDt_AfterUpdate"
    ...
    'Else
        's_woEffDt
    '    Z_Now = Me![TestEffDt]
        'MsgBox "SWO Eff Date must be greater than " & swoEffDt()
    'End If
    ...
    Else
       ...
       End If
    End If
    MsgBox "Your Run Date has been modified to " & ZNow() & "."
End Sub
...
DoCmd.OpenQuery "DispMfgAQ"
    ...
    'Left criteria: [RedeemDt]= >=Now() , etc.
    ...
    DoCmd.OpenQuery "zReadItemSubAQ"
...
'With fs
'    .LookIn = NmPath
'    .FileName = ProFind   '"Promo*.xls"
'    If .Execute > 0 Then
        'MsgBox "Will begin import of " & .FoundFiles.Count & " file(s)."
        MsgBox "Will begin import of " & FF & " file(s)."
        TotFiles.Visible = True
            Me![TotFiles] = FF '.FoundFiles.Count
        For i = 1 To FF   ' .FoundFiles.Count
        CurrFile.Visible = True
            Me![CurrFile] = i
        If DLookup("[StopIt]", "Stop") = "0" Then
           MsgBox "[Stop].[StopIt] = '0' requesting cancellation of this procedure."
           Exit Sub
        Else
           ProOld = "Error in Imp Loop Code replacing Mid(.FoundFiles(i), 51, 50). Exiting."
           'MsgBox ProOld
           Exit Sub
           Name NmPath & "\" & ProOld As NmPath & "\" & ProNew
           'MsgBox .FoundFiles(i)
...
'!!!!!!!!!!!!!!!!!!!!Here is where it is messing up!
   DoCmd.OpenQuery "zICAppQ"
   'Update Item Code listings with TOC/STOC and other descriptions
'      MsgBox "Flag 6"
   DoCmd.RunMacro "zUpDtTSM"
      'MsgBox "Flag 7"
      'Exit Sub
   ...
   '   ".  Please purge old data source files regularly."
   ImpAs.Visible = True
   Me![ImpAs] = stVC & " promotion " & stPromoNm & " " & Format(Now(), "mmddyy") & _
               stVC & " " & Format(Time(), "hhmmss") & stText & ".xls"
...
On Error GoTo Err_UpLd_Click
    ...
    Dim stExt As String
    Dim stSrc As String
    Dim stSrcPath As String
    Dim stDST As String
    Dim stDstPath As String
    Dim stNow As String
    Dim x, y
...
'****                                                   *****
'************************************************************
    IntRecs = DCount("[Item]", "DftULzQ")
       'MsgBox "There are " & IntRecs & " records to process, using " & ZNow()
       'Exit Sub

    If IntRecs > 0 Then
       DoCmd.RunMacro "DoItPromoUpLd"
    Else
       MsgBox "There are " & IntRecs & " records to process, " & _
       "using " & ZNow() & ".  Revise your date or check if there are " & _
       "promos to upload.  Cancelling this upload."
       Exit Sub  'Don't UpLoad if zero records!!!
    End If
'********************************************************************
'****                     OnClickSend()                         *****
'****                                                           *****
'****  [DftULQ]>[DftULzQ]>[DftULSQ]>[DftULPreQ]>[DftULPrePreQ]> *****
'****  [zPromo]+[zVendor]+[BuyNGetQ]>                           *****
'****  [zPromo]+[zItemSub]+[BuyNGetSamePreQ]>[zPromo]+[zItemSub]*****
'****     Where [Free]=-1, [DftPromo]=-1, [EffDate]>Now()       *****
'****                                                           *****
'****                       Testing Notes                       *****
'****                                                           *****
'****  Edit [EffDate] Criteria in [DftULPrePreQ]*, [BuyNGetQ]*, *****
'****      and [BuyNGetSamePreQ]*, i.e. Now()-120, and, edit    *****
'****  [DftULPrePreQ].[2Day]* = Format(Now()-120,"mm/dd/yyyy")] *****
'****                                                           *****
'****  Edit [DftULPrePreQ].[FreeItm]: IIf(IsNull([GetCode])     *****
'****      Then [FreeItm] = [Item] & "        "                 *****
'****      Else [FreeItm] = [GetCode] & "        ")             *****
'****                                                           *****
'********************************************************************
    
'********************************************************************
'****          Archive the DP DVLINFG file set                  *****
'****             BAT, ftp, log, and txt                        *****
'****                                                           *****
'****    from C:\temp                                           *****
'****    to                                                     *****
...
Z_Ref = "DP" & stDay & stHr & stMin & stSec
    ...
    Z_LgNt = RecCnt & " Records to Server"
    MsgBox "Dt: " & Format(Now(), "yyyymmddhhnnss") & " Ref: " & ZRef() & " U: " & ZLgUzr() & " Nt: " & ZLgNt()
...
On Error GoTo Err_PrepUpLd_Click
    ...
    MsgBox "We will be pulling Promos Effective after " & ZNow() & ". " & _
    "To change the date for testing or proofs, edit the 'Proof or Test Date' field (above)."
    'DoCmd.DoMenuItem acFormBar, acRecordsMenu, acSaveRecord, , acMenuVer70
...
Exit_CancelUpLd_Click:
    Exit Sub

Err_CancelUpLd_Click:
    MsgBox Err.Description
...
Exit_TestArchive_Click:
    Exit Sub

Err_TestArchive_Click:
    MsgBox Err.Description
...
On Error GoTo Err_SwoUpLd_Click
    ...
    stDocName = "SwoULQ"
    'DoCmd.OpenQuery stDocName, acNormal, acEdit
    DoCmd.RunMacro "SwoDoItPromoUpLd"
...
On Error GoTo Err_SWOvsDft_Click
    ...
    If DCount("*", stDocName) > 0 Then
       DoCmd.OpenQuery stDocName, acNormal, acEdit
    Else
       MsgBox "There are no Defaulted Promotions that are also marked as " & _
       "Shipped with Order Promotions."
    End If
