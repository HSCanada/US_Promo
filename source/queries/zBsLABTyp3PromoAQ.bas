...
Where ="(((zPromo.EffDate)>=ZEDtEff()) AND ((zPromo.ExpDate)<=ZEDtExp()) AND ((zPromo.Ap"
    ...
    "ftPromo)=False) AND ((zPromo.Typ3)=True) AND ((zPromo.RedeemDt) Is Not Null)) OR"
    " (((zPromo.Approvd)=True) AND ((zPromo.Deletd)=False) AND ((zPromo.SWO)=False) A"
    "ND ((zPromo.DftPromo)=False) AND ((zPromo.Typ3)=True) AND ((zPromo.RedeemDt)>=No"
    "w())) OR (((zPromo.Approvd)=True) AND ((zPromo.Deletd)=False) AND ((zPromo.SWO)="
    "False) AND ((zPromo.DftPromo)=False) AND ((zPromo.Typ3)=True) AND ((zPromo.EffYr"
