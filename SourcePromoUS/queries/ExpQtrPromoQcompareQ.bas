Operation =1
Option =0
Where ="(((zPromo.EffDate)>#12/31/2008# And (zPromo.EffDate)<#9/1/2009#) AND ((zPromo.Ty"
    "p1)=-1) AND ((zPromo.SWO)=0) AND ((zPromo.DftPromo)=0) AND ((zPromo.Deletd)=0))"
Begin InputTables
    Name ="zPromo"
    Name ="zVendor"
End
