...
Where ="(((zPromo.EffDate)>=ZEDtEff()) AND ((zPromo.ExpDate)<=ZEDtExp()) AND ((zPromo.Ap"
    ...
    ") AND ((zPromo.Typ3)=-1)) OR (((zPromo.Approvd)=-1) AND ((zPromo.Deletd)=0) AND "
    "((zPromo.SWO)=0) AND ((zPromo.DftPromo)=0) AND ((zPromo.RedeemDt)>=Now()) AND (("
    "zPromo.Typ3)=-1)) OR (((zPromo.ImpYr)=2009) AND ((zPromo.SWO)=0) AND ((zPromo.Df"
    "tPromo)=0) AND ((zPromo.Typ3)=-1))"
Begin InputTables
    Name ="zPromo"
