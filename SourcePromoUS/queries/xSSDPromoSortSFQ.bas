Operation =1
Option =0
Where ="(((xSSDPromoQ.HSImedia)=\"Sale Flyer\") AND ((xSSDPromoQ.MediaMn)=[Select Month#"
    "])) OR (((xSSDPromoQ.HSImedia)=\"Sale Flyer\") AND ((xSSDPromoQ.EffMn)=[Select M"
    "onth#])) OR (((xSSDPromoQ.HSImedia)=\"Sale Flyer\") AND ((xSSDPromoQ.ExpMn)=[Sel"
    "ect Month#])) OR (((xSSDPromoQ.HSImedia)=\"Sale Flyer\") AND ((xSSDPromoQ.EffMn)"
    "<[Select Month#]) AND ((xSSDPromoQ.ExpMn)>[Select Month#]-1))"
Begin InputTables
    Name ="xSSDPromoQ"
End
Begin OutputColumns
