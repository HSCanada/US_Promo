...
Where ="((([WCS ITEMFILE].supplr) Is Not Null) AND (([WCS ITEMFILE].itmcde) Is Not Null "
    ...
    "A\" And (Left([PRDCL1],1))<>\"C\" And (Left([PRDCL1],1))<>\"W\" And (Left([PRDCL"
    "1],1))<>\"V\") AND (([WCS ITEMFILE].prdcl1)<>\"D95\" And ([WCS ITEMFILE].prdcl1)"
    "<>\"D30\" And ([WCS ITEMFILE].prdcl1)<>\"D35\" And ([WCS ITEMFILE].prdcl1)<>\"D2"
    "5\" And ([WCS ITEMFILE].prdcl1)<>\"S10\" And ([WCS ITEMFILE].prdcl1)<>\"S20\" An"
    "d ([WCS ITEMFILE].prdcl1)<>\"S40\" And ([WCS ITEMFILE].prdcl1)<>\"S50\" And ([WC"
    "S ITEMFILE].prdcl1)<>\"S60\" And ([WCS ITEMFILE].prdcl1) Not Like \"D4*\" And (["
