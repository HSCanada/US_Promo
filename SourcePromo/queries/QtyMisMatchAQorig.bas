...
Begin OutputColumns
    ...
    Alias ="TxtVal2"
    Expression ="IIf([BuyPart]=2,Int([QtyValu]-Mid([OfferText],InStr(1,[OfferText],\" AND \")+5,I"
        "nStr(InStr(1,[OfferText],\" AND \")+5,[OfferText],\" \")+1-InStr(1,[OfferText],\""
        " AND \")-5))*1,Null)"
End
Begin Joins
    LeftTable ="zPromo"
