Operation =1
Option =0
Where ="(((xSSDPromoQ.PromoCode) Is Not Null) AND ((xSSDPromoQ.MediaMn)=[Select Month#])"
    ") OR (((xSSDPromoQ.PromoCode) Is Not Null) AND ((xSSDPromoQ.EffMn)=[Select Month"
    "#])) OR (((xSSDPromoQ.PromoCode) Is Not Null) AND ((xSSDPromoQ.ExpMn)=[Select Mo"
    "nth#])) OR (((xSSDPromoQ.PromoCode) Is Not Null) AND ((xSSDPromoQ.EffMn)<[Select"
    " Month#]) AND ((xSSDPromoQ.ExpMn)>[Select Month#]-1))"
Begin InputTables
    Name ="xSSDPromoQ"
End
Begin OutputColumns
