...
Begin Form
    ...
    RecSrcDt = Begin
        0x1464f158d617e240
    End
    RecordSource ="SELECT zVendor.ID, zVendor.Company, zVendor.VendorCode, zVendor.StreetSuite, zVe"
        "ndor.CityStZip, zVendor.VndTel, zVendor.VndFax, zVendor.WebSite FROM zVendor ORD"
        ...
        Begin Section
            ...
            Begin
                Begin Subform
                    ...
                    Width =11985
                    Height =5895
                    Name ="zPromoSubAllRecF"
                    SourceObject ="Form.zPromoSubAllRecF"
                    LinkChildFields ="ID"
                    LinkMasterFields ="ID"
...
config_log "Form_zVendorAllRecF - Form_Open"

Forms![zVendorAllRecF]![Company].SetFocus
End Sub

Private Sub Close_Click()
config_log "Form_zVendorAllRecF - Close_Click"
