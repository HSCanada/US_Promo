...
Begin Form
    ...
    PrtMip = Begin
        0xa0050000a0050000a0050000a005000000000000b83300003e1c000001000000 ,
        ...
        Begin Section
            ...
            Begin
                ...
                Begin Label
                    ...
                    ForeColor =8388736
                    Name ="Label142"
                    Caption ="Welcome to the Promotions Manager.  Please enter your User ID and click on a wor"
                        "k area."
                    FontName ="Comic Sans MS"
                End
                Begin Label
                ...
                Begin TextBox
                    ...
                    ForeColor =8388736
                    Name ="Text144"
                    ControlSource ="=\"Promotions Manager\""
                    FontName ="Comic Sans MS"
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT DISTINCTROW MmVendors.Company, MmVendors.VendorCode, MmVendors.LN, MmVend"
                        "ors.FN, MmVendors.Add1, MmVendors.Add2, MmVendors.City, MmVendors.St, MmVendors."
                        "Country FROM MmVendors WHERE (((Right([VendorCode],3))=ZUserVC())) ORDER BY MmVe"
                        "ndors.Company;"
                    ColumnWidths ="2055;1290;1260;810;1440;1440;1155;450;1440"
                ...
                Begin Label
                    ...
                    FontWeight =400
                    ForeColor =10092543
                    Name ="VndrCodeB_Label"
                    Caption ="3.A. Select Dept "
                    FontName ="Comic Sans MS"
                End
                Begin CommandButton
                    OverlapFlags =215
                ...
                Begin CommandButton
                    ...
                    TabIndex =18
                    Name ="OpenUnivF"
                    Caption ="Open My Dept Main Form"
                    OnClick ="[Event Procedure]"
...
config_log "Form_SignIn - Admin_Click"
...
On Error GoTo Err_Admin_Click
    ...
    Me.AdminTitle.SetFocus   'This way Title is visible on return"
...
config_log "Form_SignIn - AdminLabel_Click"
...
Exit_AdminLabel_Click:
    Exit Sub

Err_AdminLabel_Click:
    MsgBox Error$
    Resume Exit_AdminLabel_Click
End Sub


Private Sub Close_Form2_Click()
config_log "Form_SignIn - Close_Form2_Click"
...
config_log "Form_SignIn - Dept_Click"
Debug.Assert False
...
On Error GoTo Err_Dept_Click
   ...
   If IsNull(Me![Dept]) Then
      stDept = "Dental"   'If User wipes field, restore to Dental & MKT
      Z_UserVC = "MKT"
      Z_UserDiv = "DENTAL"
   ElseIf Me![Dept] = "Dental" Then
      stDept = "Lab"      'If current value is Dental, switch to Lab
      Z_UserVC = "LAB"
      Z_UserDiv = "ZAHN"
   ElseIf Me![Dept] = "Lab" Then
      stDept = "Dental"   'If current value is Lab, switch to Dental
      Z_UserVC = "MKT"
      Z_UserDiv = "DENTAL"
   Else
      stDept = "Dental"   'If any other value entered, switch to Dental
      Z_UserVC = "MKT"
      Z_UserDiv = "DENTAL"
   End If
   Me![Dept] = stDept     'set value for the field
   'MsgBox ZUserVC()
   UVC.Requery            'Requery the select field combo box
...
Err_Dept_Click:
    ...
    Resume Exit_Dept_Click
   
End Sub

Private Sub Form_Open(Cancel As Integer)
config_log "Form_SignIn - Form_Open"
...
config_log "Form_SignIn - Form_Timer"
If IsNull(DLookup("[Fire]", "Defaults")) Then
   'MsgBox "No Warnings Found"
Else
   'MsgBox "Z Warning"
...
config_log "Form_SignIn - XXX"
    DoCmd.OpenForm "EditSubmF", acNormal
End Sub

Private Sub GetItUB_Click()
config_log "Form_SignIn - GetItUB_Click"
On Error GoTo Err_GetItUB_Click
    ...
    'Z_From = #1/1/1990#
    'Z_To = #12/31/2040#
    Z_Sel = 1  'Use selection to determine which criteria line to use in recordsource query
    
    If IsNull(Me![UVC]) Then
       MsgBox "Select a vendor, then try a gain."
       Exit Sub
    Else
       stUVC = Me![UVC]
       Me![VC] = stUVC
       'ZVC6() is set after update of Me![UVC] in [z1___EntryScreen]
       'ZVC6() is then used in query/recordsource of forms
    End If
    
    If IsNull(Me![StartDt]) Or IsNull(Me![EndDt]) Then
       MsgBox "Please enter both From and To dates for the range of products you wish " & _
...
Err_NewTOC_Click:
    MsgBox Err.Description
    Resume Exit_NewTOC_Click
    
End Sub

Private Sub NewTOCSTOC_Click()
config_log "Form_SignIn - NewTOCSTOC_Click"
On Error GoTo Err_NewTOCSTOC_Click
    ...
    stLinkCriteria = "[TOC]=" & "'" & Me![TOC] & "'" & " And [STOC]=" & "'" & Me![STOC] & "'"
    DoCmd.OpenForm stDocName, , , stLinkCriteria

Exit_NewTOCSTOC_Click:
    Exit Sub

Err_NewTOCSTOC_Click:
    MsgBox Err.Description
    Resume Exit_NewTOCSTOC_Click
    
End Sub

Private Sub GetNewUB_Click()
config_log "Form_SignIn - GetNewUB_Click"
...
End Select
    ...
    'Status [HSIst]= SA or IP
    'CatDt = IIf([Forms]![EditSubMNewF]![Period] Is Null,
    '[CatDt],[Forms]![EditSubMNewF]![Period]) And
    '>=DLookUp("[ZVar2]","Defaults")
...
Err_GetNewUB_Click:
    MsgBox Err.Description
    Resume Exit_GetNewUB_Click
    
End Sub


Private Sub User_LostFocus()
config_log "Form_SignIn - User_LostFocus"
...
Else
   ...
   rs.FindFirst "[UserName] = '" & UserNm & "'"
   If Not rs.EOF Then Me.Bookmark = rs.Bookmark
   '[User] = "" 'Now hide the User Name
'MsgBox UserNm
   Z_UserNote = Me![Note]
   Z_UserNm = Me![Signature]
   Z_Title = Me![Title]
   Z_UserID = Me![User]
   Z_UserTel = Me![Tel]
   Z_UserDiv = Me![Div]
 ...
 'Z_UserID = DLookup("[UserName]", "[xyPermissions]", "[UserName] = '" & UserNm & "'")
 'Z_UserTel = DLookup("[UserTel]", "[xyPermissions]", "[UserName] = '" & UserNm & "'")
 'Z_UserDiv = DLookup("[Div]", "[xyPermissions]", "[UserName] = '" & UserNm & "'")
       'MsgBox "UserName = " & Z_UserID
   '[UserNote].Requery
   'Me![UserNote] = ZUserNote()
       'MsgBox "UserNote = " & Z_UserNote
   If ZUserDiv() = "DENTAL" Then
      Me![Dept] = "Dental"
      Z_UserVC = "MKT"
   ElseIf ZUserDiv() = "ZAHN" Then
      Me![Dept] = "Lab"
      Z_UserVC = "LAB"
   Else
      Me![Dept] = "Dental"
...
config_log "Form_SignIn - Command319_Click"
On Error GoTo Err_Command319_Click


    DoCmd.Quit

Exit_Command319_Click:
    Exit Sub

Err_Command319_Click:
    MsgBox Err.Description
    Resume Exit_Command319_Click
    
End Sub

Private Sub ICAdmin_Click()
config_log "Form_SignIn - ICAdmin_Click"
...
Err_ICAdmin_Click:
    MsgBox Err.Description
    Resume Exit_ICAdmin_Click
    
End Sub

Private Sub LabRpts_Click()
config_log "Form_SignIn - LabRpts_Click"
...
Err_LabRpts_Click:
    MsgBox Err.Description
    Resume Exit_LabRpts_Click
    
End Sub

Private Sub LabScn_Click()
config_log "Form_SignIn - LabScn_Click"
...
Err_LabScn_Click:
    MsgBox Err.Description
    Resume Exit_LabScn_Click
    
End Sub


Private Sub UVC_AfterUpdate()
config_log "Form_SignIn - UVC_AfterUpdate"
 On Error GoTo Err_UVC_AfterUpdate
'Use ZVC6() in NPFs to filter list of Display Names

Dim IntLen As Integer
IntLen = Len(Me![UVC]) - 4
Z_VC6 = Left(Me![UVC], IntLen)
'MsgBox ZVC6()

Exit_UVC_AfterUpdate:
    Exit Sub

Err_UVC_AfterUpdate:
    MsgBox Err.Description
    Resume Exit_UVC_AfterUpdate
End Sub
...
Err_MkToNow_Click:
    MsgBox Err.Description
    Resume Exit_MkToNow_Click
    
End Sub

Private Sub OpenSel_Click()
config_log "Form_SignIn - OpenSel_Click"
...
Err_OpenSel_Click:
    MsgBox Err.Description
    Resume Exit_OpenSel_Click
    
End Sub


Private Sub Admin3_Click()
config_log "Form_SignIn - Admin3_Click"
...
Err_Admin3_Click:
    MsgBox Err.Description
    Resume Exit_Admin3_Click
    
End Sub

Private Sub OpenMain_Click()
config_log "Form_SignIn - OpenMain_Click"
...
Err_OpenMain_Click:
    MsgBox Err.Description
    Resume Exit_OpenMain_Click
    
End Sub

Private Sub OpenUnivF_Click()
config_log "Form_SignIn - OpenUnivF_Click"
...
Exit_OpenUnivF_Click:
    Exit Sub

Err_OpenUnivF_Click:
    MsgBox Err.Description
    Resume Exit_OpenUnivF_Click
