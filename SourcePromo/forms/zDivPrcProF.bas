            ...
            Begin
                ...
                Begin UnboundObjectFrame
                    ...
                    OleData = Begin
                        ...
                        0x0000004600000000000000000000000010bfbd3ff379d30103000000800c0000 ,
                ...
                Begin Label
                    ...
                    ForeColor =13434828
                    Name ="Label23"
                    Caption ="Promo db, Divisional Pricing"
                    FontName ="Times New Roman"
                End
                Begin CommandButton
                    OverlapFlags =93
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT DISTINCT zVendor.Company, IIf(IsNull([CSubVCs]),\"Must Assign Sub Vendor "
                        "Codes\",[CSubVCs]) AS SubCds, zPromo.DivPrc FROM (zSubVCQ RIGHT JOIN zVendor ON "
                        "zSubVCQ.VendorCode = zVendor.VendorCode) INNER JOIN zPromo ON zVendor.ID = zProm"
                        "o.ID WHERE (((zPromo.DivPrc)=-1) AND ((zPromo.EffYr)=ZEffYr() Or (zPromo.EffYr)="
                        "ZEffYr()+1 Or (zPromo.EffYr)=ZEffYr()-1)) OR (((zPromo.DivPrc)=-1) AND ((zPromo."
                        "EffDate)<Now()) AND ((zPromo.RedeemDt)>Now())) OR (((zPromo.DivPrc)=-1) AND ((zP"
                        "romo.EffYr) Is Null) AND ((zPromo.EffDate) Is Null) AND ((zPromo.RedeemDt) Is Nu"
                        "ll)) ORDER BY zVendor.Company;"
                    ColumnWidths ="2397;1124;2715"
                ...
                Begin Subform
                    ...
                    TabIndex =16
                    Name ="zDivPrcProSF"
                    SourceObject ="Form.zDivPrcProSF"
                    LinkChildFields ="ID"
                    LinkMasterFields ="ID"
...
Debug.Print "Form_zDivPrcProF - Form_Open"

   'Forms![zVendorSelRecF]![Company].SetFocus
End Sub

Private Sub Close_Click()
Debug.Print "Form_zDivPrcProF - Close_Click"
...
Debug.Print "Form_zDivPrcProF - SelGoVndr_AfterUpdate"
...
Debug.Print "Form_zDivPrcProF - GoRecID_Click"
On Error GoTo Err_GoRecID_Click
    ...
    Else
        Me.Bookmark = rst.Bookmark
        'Me.zVndDefProSF.SetFocus  'zPromoSubSelRecF" '4/17/15
        'Me.RecID.SetFocus '4/17/15
        DoCmd.FindRecord intRec, acEntire, , acSearchAll, , acCurrent
        ' '4/17/15Me.Unbnd.SetFocus '4/17/15
    End If
...
Debug.Print "Form_zDivPrcProF - zVndDefProSF_Enter"
...
'Forms!zAdminF!vVndContactsF.Form![VC6digit]
'MsgBox ZMktID()
End Sub
