...
Debug.Print "Form_zSWOHdrVuF - Form_AfterDelConfirm"
...
Forms!zSWOVuF![BuyCnt] = HBuyCnt()  '?Not work in OnClose procedure?
...
Next a
Forms!zSWOVuF![OfferText] = HOffer()
'DoCmd.OpenQuery "BuyOfferUQ"      'Works too. Both do same...
'MsgBox "HOffer = " & HOffer()
End Sub

Private Sub Form_AfterUpdate()
Debug.Print "Form_zSWOHdrVuF - Form_AfterUpdate"
