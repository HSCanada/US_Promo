        ...
        Begin FormHeader
            ...
            Begin
                ...
                Begin Label
                    ...
                    FontWeight =700
                    Name ="Label38"
                    Caption ="Finalize List of Selected Vendors for Quarterly Mailing - CLOSE WHEN SELECTIONS "
                        "ARE OK"
                ...
                Begin Label
                    ...
                    ForeColor =65535
                    Name ="Label39"
                    Caption ="Delete the vendors you do not want to send to.  Next time you open this screen a"
                        "ll vendors will again appear."
                    FontName ="Small Fonts"
                    Tag ="DetachedLabel"
                End
            End
