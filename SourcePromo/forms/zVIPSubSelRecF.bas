...
Begin Form
    ...
    RecSrcDt = Begin
        0xeda32c51b00ae440
    End
    RecordSource ="SELECT zPromo.EffDate, zPromo.PendingId, zPromo.PromoNm, zPromo.ExpDate, zPromo."
        "MediaMn, zPromo.RecID, zPromo.ID, zPromo.HSImedia, zPromo.SubmittedBy, zPromo.Su"
        "bmitDt, zPromo.SubmitOffice, zPromo.Title, zPromo.Tel, zPromo.Ext, zPromo.Fax, z"
        "Promo.Email, zPromo.Type, zPromo.PromoOffer, zPromo.OfferText, zPromo.Tier1, zPr"
        "omo.Tier2, zPromo.Tier3, zPromo.Tier4, zPromo.TOC, zPromo.TOCNm, zPromo.STOC, zP"
        "romo.STOCNm, zPromo.EffMnth, zPromo.SamplDesc, zPromo.Lit, zPromo.PcsRep, zPromo"
        ".PcsCtr, zPromo.Div, zPromo.Dept, zPromo.TargetGroup, zPromo.TargetZone, zPromo."
        "OrderLevel, zPromo.SWO, zPromo.RedeemDt, zPromo.RedeemOpt, zPromo.RdmTel, zPromo"
        ".RdmFax, zPromo.FSCSells, zPromo.FSCGets, zPromo.HSIMinVolume, zPromo.HSIRebate,"
        " zPromo.BuyInOffer, zPromo.BuyInStart, zPromo.BuyInEnd, zPromo.Fulfillment, zPro"
        "mo.Quantity, zPromo.Notes, zPromo.PromoCode, zPromo.EZ, zPromo.MP, zPromo.WhoGet"
        "s, zPromo.HowSent, zPromo.SentDate, zPromo.DistReps, zPromo.HSIContact, zPromo.F"
        "lyerPg, zPromo.FldCom, zPromo.FldNotes, zPromo.MgdNotes, zPromo.StreetSuite, zPr"
        "omo.CityStZip, zPromo.VndTel, zPromo.VndFax, zPromo.WebSite, zPromo.PromoCd, zPr"
        "omo.AdMn, zPromo.AdStart, zPromo.AdEnd, zPromo.Approvd, zPromo.ApprvDt, zPromo.A"
        "pprvBy, zPromo.DftPromo, zPromo.DftPg, zPromo.DftFlier, zPromo.SaleFlyer, zPromo"
        ".Deletd, zPromo.DelDt, zPromo.DelUSER, zPromo.EffMnth, zPromo.EffQtr, zPromo.Eff"
        "Yr, zPromo.RedeemDt, ZPer() AS Per, zPromo.Typ1, zPromo.Typ2, zPromo.Typ3, zProm"
        "o.Typ4, zPromo.Typ5, zPromo.Typ6, zPromo.Typ7, zPromo.Typ8, zPromo.Typ9, zPromo."
        "Typ10, zPromo.Typ11, zPromo.Typ12, zPromo.RdmOpt1, zPromo.RdmOpt2, zPromo.RdmOpt"
        "3, zPromo.RdmOpt4, zPromo.RdmOpt5, zPromo.GetValu, zPromo.BuyCnt, zPromo.[1inv],"
        " zPromo.DftNote, zPromo.Comment, zPromo.Same, zPromo.BrandNmPkg, zPromo.ImpDt, I"
        "If(IsNull([DefPro].[DftPromo]),Null,\"D\") AS DftSub FROM zPromo LEFT JOIN DefPr"
        "o ON zPromo.RecID = DefPro.RecID WHERE (((zPromo.EffQtr)=ZEffQtr()) AND ((zPromo"
        ".EffYr)=ZEffYr())) OR (((zPromo.EffMnth)=ZEffMn()) AND ((zPromo.EffYr)=ZEffYr())"
        ") ORDER BY zPromo.PromoNm, zPromo.ExpDate, zPromo.MediaMn;"
    Caption ="zPromo"
