...
On Error GoTo Err_CopyAdd_Click
    ...
    stDocName = "zItemSubSelAQ"  'Pulls from "zItemSubSelRecQ"
    DoCmd.DoMenuItem acFormBar, acRecordsMenu, acSaveRecord, , acMenuVer70
    
    If DCount("[HSICode]", "zItemSubSelOKRecQ") = 0 Then
        MsgBox "There are no ItemCodes to add. Perhaps all the " & _
        "ItemCodes are already included."
    Else
