...
Begin Form
    ...
    RecordSource ="SELECT DISTINCTROW CorpList.RecID, CorpList.Company, CorpList.VendorCode, CorpLi"
        ...
        "CorpList.MiscDef, CorpList.NoPrnt, CorpList.Option1, CorpList.Option2, CorpList."
        "Option3, CorpList.Option4, CorpList.FnTel, CorpList.FnFax, CorpList.CorpMail, Co"
        "rpList.Promo, CorpList.DCMktTo, CorpList.DCMktCC, CorpList.DCEqpTo, CorpList.DCE"
        "qpCC, CorpList.DCLabTo, CorpList.DCLabCC, CorpList.DCProTo, CorpList.DCProCC, Co"
        "rpList.DC4To, CorpList.DC4CC, CorpList.DC5To, CorpList.DC5CC, CorpList.DC6To, Co"
        "rpList.DC6CC, CorpList.DSMktTo, CorpList.DSMktCC, CorpList.DSEqpTo, CorpList.DSE"
        "qpCC, CorpList.DSLabTo, CorpList.DSLabCC, CorpList.DSProTo, CorpList.DSProCC, Co"
        "rpList.DS4To, CorpList.DS4CC, CorpList.DS5To, CorpList.DS5CC, CorpList.DS6To, Co"
        "rpList.DS6CC, CorpList.MrchD, CorpList.MrchZ FROM CorpList WHERE (((CorpList.LN)"
        " Is Not Null)) ORDER BY CorpList.Company, CorpList.LN;"
        ...
        Begin FormHeader
            ...
            Begin
                ...
                Begin Label
                    ...
                    ForeColor =65535
                    Name ="Label377"
                    Caption ="ONLY THE PROMO 'FLAG' MAY BE EDITED"
                End
                Begin CommandButton
                    OverlapFlags =85
                    Left =8505
...
config_log "Form_vVndrCorpF - Deadline___Eff__Mont_Click"
...
config_log "Form_vVndrCorpF - Exit_Deadlin_Mn_Click"
...
config_log "Form_vVndrCorpF - Form_AfterUpdate"
    DoCmd.DoMenuItem acFormBar, acRecordsMenu, acSaveRecord, , acMenuVer70
End Sub

Private Sub Form_Close()
config_log "Form_vVndrCorpF - Form_Close"
   DoCmd.DoMenuItem acFormBar, acRecordsMenu, acSaveRecord, , acMenuVer70
End Sub

Private Sub Form_Current()
config_log "Form_vVndrCorpF - Form_Current - PASS"

'Dim stVC As String
'D'im stCompany As String

'If (IsNull(Me![VC6digit])) Then
'   stVC = Forms!vVndContactsF![VC6digit]
'   DoCmd.GoToControl "VC6digit"
'   [VC6digit] = stVC
'End If
'If (IsNull(Me![Company])) Then
'   If Not IsNull(Forms!vVndContactsF![Company]) Then
'      stCompany = Forms!vVndContactsF![Company]
...
config_log "Form_vVndrCorpF - Open_Vndr_Edit_Form__Click"
...
config_log "Form_vVndrCorpF - FaxCvrB_Click"
...
config_log "Form_vVndrCorpF - Eml_Click"
...
config_log "Form_vVndrCorpF - Close_Click"
