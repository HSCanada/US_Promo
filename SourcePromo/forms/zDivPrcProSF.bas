...
Begin Form
    ...
    RecordSource ="SELECT DISTINCT zPromo.EffDate, zPromo.PendingId, zPromo.PromoNm, zPromo.ExpDate"
        ...
        " zPromo.ApprvBy, zPromo.DivPrc, zPromo.DftPg, zPromo.DftFlier, zPromo.SaleFlyer,"
        " zPromo.Deletd, zPromo.DelDt, zPromo.DelUSER, zPromo.EffMnth, zPromo.EffQtr, zPr"
        "omo.EffYr, zPromo.EffDate, zPromo.RedeemDt, ZPer() AS Per, zPromo.Typ1, zPromo.T"
        "yp2, zPromo.Typ3, zPromo.Typ4, zPromo.Typ5, zPromo.Typ6, zPromo.Typ7, zPromo.Typ"
        "8, zPromo.Typ9, zPromo.Typ10, zPromo.Typ11, zPromo.Typ12, zPromo.RdmOpt1, zPromo"
        ".RdmOpt2, zPromo.RdmOpt3, zPromo.RdmOpt4, zPromo.RdmOpt5, zPromo.GetValu, zPromo"
        ".BuyCnt, zPromo.[1inv], zPromo.DftNote, zPromo.Comment, zPromo.Same, zPromo.Bran"
        "dNmPkg, zPromo.ImpDt, zPromo.DivPrc, zPromo.DftPromo, DefPro.DftD FROM zPromo LE"
        "FT JOIN DefPro ON zPromo.RecID = DefPro.RecID WHERE (((zPromo.EffYr)=ZEffYr() Or"
        " (zPromo.EffYr)=ZEffYr()+1 Or (zPromo.EffYr)=ZEffYr()-1 Or (zPromo.EffYr)=ZEffYr"
        "()-2) AND ((zPromo.DivPrc)=True)) OR (((zPromo.EffDate)<Now()) AND ((zPromo.Rede"
        "emDt)>Now()) AND ((zPromo.DivPrc)=True)) ORDER BY zPromo.PromoNm, zPromo.ExpDate"
        " DESC , zPromo.MediaMn DESC;"
    Caption ="zPromo"
...
config_log "Form_zDivPrcProSF - AdMn_AfterUpdate"
...
config_log "Form_zDivPrcProSF - Approvd_AfterUpdate"
    Me![ApprvDt] = Format(Now(), "mm/dd/yyyy")
End Sub

Private Sub Deletd_AfterUpdate()
config_log "Form_zDivPrcProSF - Deletd_AfterUpdate"
    Me![DelDt] = Format(Now(), "mm/dd/yyyy")
End Sub

Private Sub DftPromo_AfterUpdate()
config_log "Form_zDivPrcProSF - DftPromo_AfterUpdate"
...
config_log "Form_zDivPrcProSF - EffMnth_LostFocus"
CopyRec.Visible = "False"
End Sub

Private Sub Form_AfterUpdate()
config_log "Form_zDivPrcProSF - Form_AfterUpdate"
...
config_log "Form_zDivPrcProSF - Type_AfterUpdate"
...
config_log "Form_zDivPrcProSF - Unbnd_GotFocus"
Dim lngRed As Long
lngRed = RGB(255, 0, 0)
...
config_log "Form_zDivPrcProSF - ViewDet_Click"
...
config_log "Form_zDivPrcProSF - Export_Click"
...
config_log "Form_zDivPrcProSF - CopyRec_Click"
...
config_log "Form_zDivPrcProSF - zVndDefProSF_Enter"
...
config_log "Form_zDivPrcProSF - HideCopy_Click"
