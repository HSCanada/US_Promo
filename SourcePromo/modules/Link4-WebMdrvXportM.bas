...
'****                                                 *****
'****   Prod  M:\Dental\dentmkt\2KFLDTBL.mdb          *****
'****   QA  M:\Dental\dentmkt\Promo\2KFLDTBL.mdb      *****
'****                                                 *****
'**********************************************************
'\\nym2212t\corpshare\Dental\dentmkt\2KFLDTBL.mdb
'\\nym2212t\corpshare\Dental\dentmkt\Promo\2KFLDTBL.mdb
...
If stMyDir = "X:\PromoQA" Then
    ...
    strServerFind = InputBox("Enter the Server Path you want to replace (current).  EX: \\nym2212t\corpshare", _
        "Server Path", "\\nym2212t\corpshare\dental\dentmkt")
    strDrive = InputBox("Enter the Drive letter to replace.  EX: M:\", _
        "Server Path", "M:\")
