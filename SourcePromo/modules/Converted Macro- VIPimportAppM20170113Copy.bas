...
'------------------------------------------------------------
' VIPimportAppM20170113Copy
'
'------------------------------------------------------------
Function VIPimportAppM20170113Copy()
Debug.Print "VIPimportAppM20170113Copy_XXX"
Debug.Assert False

On Error GoTo VIPimportAppM20170113Copy_Err
...
VIPimportAppM20170113Copy_Exit:
    Exit Function

VIPimportAppM20170113Copy_Err:
    MsgBox Error$
    Resume VIPimportAppM20170113Copy_Exit
